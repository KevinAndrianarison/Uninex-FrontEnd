...
function delibRed() {
  listeRed.value.forEach((etd) => {
    fetch(
      ...
      au.idAUDelibRed,
      etd.cursu_id,
      niveau.idniveauDelibRed,
    )
  })
}

function fetch(user_id, email, nomComplet_etud, Semestre, status, idAU, cursu_id, niveau) {
